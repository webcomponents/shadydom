...
Moreover, on old versions of Chrome and Safari, you have to call `ShadyDOM.path(node)`
to properly construct the accessors.
(This excludes Safari 9, where property descriptors can not be set as they are not `configurable`).
