...
*/
'use strict';function n(a,b){return{index:a,j:[],o:b}}
function aa(a,b,c,d){var e=0,h=0,g=0,f=0,k=Math.min(b-e,d-h);if(0==e&&0==h)a:{for(g=0;g<k;g++)if(a[g]!==c[g])break a;g=k}if(b==a.length&&d==c.length){for(var f=a.length,l=c.length,m=0;m<k-g&&ba(a[--f],c[--l]);)m++;f=m}e+=g;h+=g;b-=f;d-=f;if(!(b-e||d-h))return[];if(e==b){for(b=n(e,0);h<d;)b.j.push(c[h++]);return[b]}if(h==d)return[n(e,b-e)];k=e;g=h;d=d-g+1;f=b-k+1;b=Array(d);for(l=0;l<d;l++)b[l]=Array(f),b[l][0]=l;for(l=0;l<f;l++)b[0][l]=l;for(l=1;l<d;l++)for(m=1;m<f;m++)if(a[k+m-1]===c[g+l-1])b[l][m]=
b[l-1][m-1];else{var q=b[l-1][m]+1,y=b[l][m-1]+1;b[l][m]=q<y?q:y}k=b.length-1;g=b[0].length-1;d=b[k][g];for(a=[];0<k||0<g;)k?g?(f=b[k-1][g-1],l=b[k-1][g],m=b[k][g-1],q=l<m?l<f?l:f:m<f?m:f,q==f?(f==d?a.push(0):(a.push(1),d=f),k--,g--):q==l?(a.push(3),k--,d=l):(a.push(2),g--,d=m)):(a.push(3),k--):(a.push(2),g--);a.reverse();b=void 0;k=[];for(g=0;g<a.length;g++)switch(a[g]){case 0:b&&(k.push(b),b=void 0);e++;h++;break;case 1:b||(b=n(e,0));b.o++;e++;b.j.push(c[h]);h++;break;case 2:b||(b=n(e,0));b.o++;
e++;break;case 3:b||(b=n(e,0)),b.j.push(c[h]),h++}b&&k.push(b);return k}function ba(a,b){return a===b};var p=window.ShadyDOM||{};p.T=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var t=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");p.h=!!(t&&t.configurable&&t.get);p.K=p.force||!p.T;function u(a){return"ShadyRoot"===a.N}function v(a){a=a.getRootNode();if(u(a))return a}var w=Element.prototype,ca=w.matches||w.matchesSelector||w.mozMatchesSelector||w.msMatchesSelector||w.oMatchesSelector||w.webkitMatchesSelector;
...
f.__shady.assignedSlot=y,l[r]=void 0,y=!0)}if(!y)for(l=k.childNodes,r=0;r<l.length;r++)f=l[r],f.__shady.D!=k&&(q=!0),L=k,L.__shady.assignedNodes.push(f),f.__shady.assignedSlot=L;if(m){for(f=0;f<m.length;f++)m[f].__shady.D=null;k.__shady.assignedNodes.length<m.length&&(q=!0)}m=k.__shady.assignedNodes;k.__shady.g=[];for(f=0;f<m.length&&(g=m[f]);f++)if(g.localName&&"slot"==g.localName){if(l=g.__shady.g)for(r=0;r<l.length;r++)k.__shady.g.push(l[r])}else k.__shady.g.push(m[f]);q&&Ia(this,k);(g=(g=h.parentNode)&&
...
function Ia(a,b){U.dispatchEvent.call(b,new Ea("slotchange"));b.__shady.assignedSlot&&Ia(a,b.__shady.assignedSlot)}V.prototype.v=function(a){return!a.__shady.assignedSlot};var Ja={};function W(a,b){if(a!==Ja)throw new TypeError("Illegal constructor");a=document.createDocumentFragment();a.__proto__=W.prototype;a.N="ShadyRoot";T(b);T(a);b.shadowRoot=a;a.host=b;a.f=!1;a.C=!1;a.c=new V(a);a.update();return a}W.prototype=Object.create(DocumentFragment.prototype);W.prototype.update=function(){var a=this;this.f||(this.f=!0,ga(function(){return Ka(a)}))};
function Ka(a){if(a.f){for(var b=a;a;){a.f&&(b=a);a:{var c;c=a;a=c.host.getRootNode();if(u(a))for(var d=c.host.childNodes,e=0;e<d.length;e++)if(c=d[e],c.localName&&"slot"==c.localName)break a;a=void 0}}b._render()}}W.prototype._render=function(){this.C=this.f=!1;this.m||La(this);this.m=!1;this.F();Ma(this.host,Na(this,this.host));for(var a=Ga(this),b=0,c=a.length,d,e;b<c&&(d=a[b]);b++)e=d.parentNode,e!==this.host&&e!==this&&Ma(e,Na(this,e))};W.prototype.F=function(){for(var a=this.c.F(),b=0;b<a.length;b++)a[b]._render()};
function La(a){var b=a.b;if(b)for(var c=0,d;c<b.length;c++)d=b[c],d.getRootNode()!==a&&Ha(d);b=a.b=a.c.root.querySelectorAll("slot");for(a=0;a<b.length;a++)d=b[a],d.__shady=d.__shady||{},T(d),T(d.parentNode)}function Na(a,b){var c=[];b=(b.__shady&&b.__shady.root||b).childNodes;for(var d=0;d<b.length;d++){var e=b[d];if(e.localName&&"slot"==e.localName)for(var h=e.__shady.g||(e.__shady.g=[]),g=0;g<h.length;g++){var f=h[g];a.v(e,f)&&c.push(f)}else c.push(e)}return c}
W.prototype.v=function(a,b){return this.c.v(a,b)};function Ma(a,b){for(var c=I.childNodes(a),d=aa(b,b.length,c,c.length),e=0,h=0,g;e<d.length&&(g=d[e]);e++){for(var f=0,k;f<g.j.length&&(k=g.j[f]);f++)I.parentNode(k)===a&&U.removeChild.call(a,k),c.splice(g.index+h,1);h-=g.o}for(e=0;e<d.length&&(g=d[e]);e++)for(h=c[g.index],f=g.index;f<g.index+g.o;f++)k=b[f],U.insertBefore.call(a,k,h),c.splice(f,0,k)}function Fa(a){return!(!a.b||!a.b.length)}function Ga(a){a.b||La(a);return a.b}
...
function db(a,b){a.__shady=a.__shady||{};a.__shady.i||(a.__shady.i=new bb);a.__shady.i.s.add(b);var c=a.__shady.i;return{P:b,S:c,R:a,takeRecords:function(){return c.takeRecords()}}}function eb(a){var b=a&&a.S;b&&(b.s.delete(a.P),b.s.size||(a.R.__shady.i=null))}
...
Db);window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,Bb);Z(Gb.prototype,Fb);p.h&&(S(window.Node.prototype),S(window.Text.prototype),S(window.DocumentFragment.prototype),S(window.Element.prototype),S(Gb.prototype),S(window.Document.prototype),window.HTMLSlotElement&&S(window.HTMLSlotElement.prototype));window.ShadowRoot=W};
}).call(self);
